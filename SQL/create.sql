...
CREATE TABLE IF NOT EXISTS tokens (
	...
	CONSTRAINT fk_tokens_user1 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS mac_address (
	id INT UNSIGNED NOT NULL AUTO_INCREMENT,
	sect1 TINYINT UNSIGNED NOT NULL,
	sect2 TINYINT UNSIGNED NOT NULL,
	sect3 TINYINT UNSIGNED NOT NULL,
	sect4 TINYINT UNSIGNED NOT NULL,
	sect5 TINYINT UNSIGNED NOT NULL,
	sect6 TINYINT UNSIGNED NOT NULL,
	PRIMARY KEY (id)
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS permissions (
	...
	CONSTRAINT fk_permissions_users1 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;